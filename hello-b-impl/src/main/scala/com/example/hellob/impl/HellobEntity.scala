...
/**
  * This is an event sourced entity. It has a state, [[HellobState]], which
  ...
  */
class HellobEntity extends PersistentEntity {

  override type Command = HellobCommand[_]
  override type Event = HellobEvent
  override type State = HellobState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: HellobState = HellobState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case HellobState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        HellobState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class HellobState(message: String, timestamp: String)
...
object HellobState {
  /**
    ...
    */
  implicit val format: Format[HellobState] = Json.format
}

/**
  * This interface defines all the events that the HellobEntity supports.
  */
sealed trait HellobEvent extends AggregateEvent[HellobEvent] {
  def aggregateTag: AggregateEventTag[HellobEvent] = HellobEvent.Tag
}

object HellobEvent {
  val Tag: AggregateEventTag[HellobEvent] = AggregateEventTag[HellobEvent]
}

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends HellobEvent
...
/**
  * This interface defines all the commands that the HellobEntity supports.
  */
sealed trait HellobCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends HellobCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String) extends HellobCommand[String]
...
/**
  ...
  * application loader.
  */
object HellobSerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    JsonSerializer[UseGreetingMessage],
    JsonSerializer[Hello],
    JsonSerializer[GreetingMessageChanged],
    JsonSerializer[HellobState]
  )
}
