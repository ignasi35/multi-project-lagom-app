package com.example.hellog.api
...
object HellogService  {
  val TOPIC_NAME = "greetingsg"
}

/**
  * The hello-g service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the HellogService.
  */
trait HellogService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("hello-g")
      .withCalls(
        pathCall("/api/hellog/:id", hello _),
        pathCall("/api/hellog/:id", useGreeting _)
      )
      .withTopics(
        topic(HellogService.TOPIC_NAME, greetingsTopic _)
