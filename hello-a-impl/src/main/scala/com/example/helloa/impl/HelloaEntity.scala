...
/**
  * This is an event sourced entity. It has a state, [[HelloaState]], which
  ...
  */
class HelloaEntity extends PersistentEntity {

  override type Command = HelloaCommand[_]
  override type Event = HelloaEvent
  override type State = HelloaState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: HelloaState = HelloaState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case HelloaState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        HelloaState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class HelloaState(message: String, timestamp: String)
...
object HelloaState {
  /**
    ...
    */
  implicit val format: Format[HelloaState] = Json.format
}

/**
  * This interface defines all the events that the HelloaEntity supports.
  */
sealed trait HelloaEvent extends AggregateEvent[HelloaEvent] {
  def aggregateTag: AggregateEventTag[HelloaEvent] = HelloaEvent.Tag
}

object HelloaEvent {
  val Tag: AggregateEventTag[HelloaEvent] = AggregateEventTag[HelloaEvent]
}

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends HelloaEvent
...
/**
  * This interface defines all the commands that the HelloaEntity supports.
  */
sealed trait HelloaCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends HelloaCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String) extends HelloaCommand[String]
...
/**
  ...
  * application loader.
  */
object HelloaSerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    JsonSerializer[UseGreetingMessage],
    JsonSerializer[Hello],
    JsonSerializer[GreetingMessageChanged],
    JsonSerializer[HelloaState]
  )
}
