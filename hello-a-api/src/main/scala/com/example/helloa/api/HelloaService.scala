package com.example.helloa.api
...
object HelloaService  {
  val TOPIC_NAME = "greetings-a"
}

/**
  * The hello-a service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the HelloaService.
  */
trait HelloaService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("hello-a")
      .withCalls(
        pathCall("/api/helloa/:id", hello _),
        pathCall("/api/helloa/:id", useGreeting _)
      )
      .withTopics(
        topic(HelloaService.TOPIC_NAME, greetingsTopic _)
