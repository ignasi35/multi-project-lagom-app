package com.example.helloe.api
...
object HelloeService  {
  val TOPIC_NAME = "greetingse"
}

/**
  * The hello-e service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the HelloeService.
  */
trait HelloeService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("hello-e")
      .withCalls(
        pathCall("/api/helloe/:id", hello _),
        pathCall("/api/helloe/:id", useGreeting _)
      )
      .withTopics(
        topic(HelloeService.TOPIC_NAME, greetingsTopic _)
