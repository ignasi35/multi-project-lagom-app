package com.example.helloi.api
...
object HelloiService  {
  val TOPIC_NAME = "greetingsi"
}

/**
  * The hello-i service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the HelloiService.
  */
trait HelloiService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("hello-i")
      .withCalls(
        pathCall("/api/helloi/:id", hello _),
        pathCall("/api/helloi/:id", useGreeting _)
      )
      .withTopics(
        topic(HelloiService.TOPIC_NAME, greetingsTopic _)
