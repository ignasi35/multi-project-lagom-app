package com.example.helloh.api
...
object HellohService  {
  val TOPIC_NAME = "greetingsh"
}

/**
  * The hello-h service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the HellohService.
  */
trait HellohService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("hello-h")
      .withCalls(
        pathCall("/api/helloh/:id", hello _),
        pathCall("/api/helloh/:id", useGreeting _)
      )
      .withTopics(
        topic(HellohService.TOPIC_NAME, greetingsTopic _)
