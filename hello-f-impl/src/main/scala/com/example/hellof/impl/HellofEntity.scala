...
/**
  * This is an event sourced entity. It has a state, [[HellofState]], which
  ...
  */
class HellofEntity extends PersistentEntity {

  override type Command = HellofCommand[_]
  override type Event = HellofEvent
  override type State = HellofState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: HellofState = HellofState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case HellofState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        HellofState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class HellofState(message: String, timestamp: String)
...
object HellofState {
  /**
    ...
    */
  implicit val format: Format[HellofState] = Json.format
}

/**
  * This interface defines all the events that the HellofEntity supports.
  */
sealed trait HellofEvent extends AggregateEvent[HellofEvent] {
  def aggregateTag: AggregateEventTag[HellofEvent] = HellofEvent.Tag
}

object HellofEvent {
  val Tag: AggregateEventTag[HellofEvent] = AggregateEventTag[HellofEvent]
}

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends HellofEvent
...
/**
  * This interface defines all the commands that the HellofEntity supports.
  */
sealed trait HellofCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends HellofCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String) extends HellofCommand[String]
...
/**
  ...
  * application loader.
  */
object HellofSerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    JsonSerializer[UseGreetingMessage],
    JsonSerializer[Hello],
    JsonSerializer[GreetingMessageChanged],
    JsonSerializer[HellofState]
  )
}
