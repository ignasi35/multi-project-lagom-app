package com.example.helloc.api
...
object HellocService  {
  val TOPIC_NAME = "greetingsc"
}

/**
  * The hello-c service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the HellocService.
  */
trait HellocService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("hello-c")
      .withCalls(
        pathCall("/api/helloc/:id", hello _),
        pathCall("/api/helloc/:id", useGreeting _)
      )
      .withTopics(
        topic(HellocService.TOPIC_NAME, greetingsTopic _)
