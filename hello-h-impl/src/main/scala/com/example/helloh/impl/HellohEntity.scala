...
/**
  * This is an event sourced entity. It has a state, [[HellohState]], which
  ...
  */
class HellohEntity extends PersistentEntity {

  override type Command = HellohCommand[_]
  override type Event = HellohEvent
  override type State = HellohState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: HellohState = HellohState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case HellohState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        HellohState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class HellohState(message: String, timestamp: String)
...
object HellohState {
  /**
    ...
    */
  implicit val format: Format[HellohState] = Json.format
}

/**
  * This interface defines all the events that the HellohEntity supports.
  */
sealed trait HellohEvent extends AggregateEvent[HellohEvent] {
  def aggregateTag: AggregateEventTag[HellohEvent] = HellohEvent.Tag
}

object HellohEvent {
  val Tag: AggregateEventTag[HellohEvent] = AggregateEventTag[HellohEvent]
}

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends HellohEvent
...
/**
  * This interface defines all the commands that the HellohEntity supports.
  */
sealed trait HellohCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends HellohCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String) extends HellohCommand[String]
...
/**
  ...
  * application loader.
  */
object HellohSerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    JsonSerializer[UseGreetingMessage],
    JsonSerializer[Hello],
    JsonSerializer[GreetingMessageChanged],
    JsonSerializer[HellohState]
  )
}
