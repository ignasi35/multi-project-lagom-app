package com.example.hellof.api
...
object HellofService  {
  val TOPIC_NAME = "greetingsf"
}

/**
  * The hello-f service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the HellofService.
  */
trait HellofService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("hello-f")
      .withCalls(
        pathCall("/api/hellof/:id", hello _),
        pathCall("/api/hellof/:id", useGreeting _)
      )
      .withTopics(
        topic(HellofService.TOPIC_NAME, greetingsTopic _)
