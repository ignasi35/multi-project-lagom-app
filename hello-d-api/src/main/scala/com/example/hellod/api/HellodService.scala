package com.example.hellod.api
...
object HellodService  {
  val TOPIC_NAME = "greetingsd"
}

/**
  * The hello-d service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the HellodService.
  */
trait HellodService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("hello-d")
      .withCalls(
        pathCall("/api/hellod/:id", hello _),
        pathCall("/api/hellod/:id", useGreeting _)
      )
      .withTopics(
        topic(HellodService.TOPIC_NAME, greetingsTopic _)
