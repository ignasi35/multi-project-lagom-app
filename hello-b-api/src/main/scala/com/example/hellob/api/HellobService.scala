package com.example.hellob.api
...
object HellobService  {
  val TOPIC_NAME = "greetingsb"
}

/**
  * The hello-b service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the HellobService.
  */
trait HellobService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("hello-b")
      .withCalls(
        pathCall("/api/hellob/:id", hello _),
        pathCall("/api/hellob/:id", useGreeting _)
      )
      .withTopics(
        topic(HellobService.TOPIC_NAME, greetingsTopic _)
